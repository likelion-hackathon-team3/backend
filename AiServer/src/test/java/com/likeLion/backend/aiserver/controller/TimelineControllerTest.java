...
class TimelineControllerTest {
    ...
    void generateTimeline_todayMode_withUserNotes_success() throws Exception {
        ...
        TimelineGenerateResponse response = new TimelineGenerateResponse(
                ...
                List.of(
                        new TimelineItemDto("2026-07-12T23:00", "저녁 식사", "단백질 위주의 가벼운 식사를 권장해요.", ActivityType.MEAL, null),
                        new TimelineItemDto("2026-07-12T23:40", "취침 준비", "샤워 및 조명 낮추기", ActivityType.PREPARATION, null),
                        new TimelineItemDto("2026-07-13T00:10", "취침", "수면 목표 5시간 20분", ActivityType.SLEEP, "권장 수면 시간: 5시간 20분"),
                        new TimelineItemDto("2026-07-13T05:30", "기상", "물 한 잔과 스트레칭", ActivityType.WAKE_UP, null),
                        new TimelineItemDto("2026-07-13T06:30", "D 근무 시작", "병원 도착 및 인수인계", ActivityType.WORK, null)
                ),
                List.of(
                        "오늘은 수면 확보가 가장 중요해요.",
        ...
        mockMvc.perform(post("/api/timeline/generate")
                ...
                .andExpect(jsonPath("$.timelineItems[0].time").value("2026-07-12T23:00"))
    ...
    void generateTimeline_futureMode_success() throws Exception {
        ...
        TimelineGenerateResponse response = new TimelineGenerateResponse(
                ...
                "표준 교대 루틴에 맞춘 일정입니다.",
                List.of(
                        new TimelineItemDto("2026-07-15T18:00", "사전 쪽잠", "야간 근무 전 필수 수면", ActivityType.NAP, "권장 낮잠: 2시간"),
                        new TimelineItemDto("2026-07-15T23:00", "NIGHT 근무 시작", "야간 근무", ActivityType.WORK, null)
                ),
